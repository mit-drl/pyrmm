...
# based on examples here: https://pytorch-lightning.readthedocs.io/en/stable/common/evaluation.html
trainer = Trainer()
trainer.test(model=pl_module.model, datamodule=data_module)

# alternative, more manual approach to evaluation
pl_module.eval()
